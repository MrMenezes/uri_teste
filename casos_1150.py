...
'''Descição:Faa um programa que leia dois inteiros: X e Z (devem ser lidos tantos valores para Z quantos necessrios, at que seja digitado um valor maior do que X para ele). Conte quantos nmeros inteiros devem ser somados em sequncia (considerando o X nesta soma) para que a soma ultrapasse a Z o mnimo possvel. Escreva o valor final da contagem.   
